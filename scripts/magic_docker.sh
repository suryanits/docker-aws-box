...
sudo apt install -y tree;sudo apt install -y python;sudo apt install -y python-pip;
sudo pip install virtualenv
virtualenv venv;source venv/bin/activate;
pip install awscli;pip install --upgrade pip;pip install boto3;pip install jmespath-terminal
...
#touch ~/.bash_profile
#echo "export PATH=$PATH:/opt/node-v8/bin" >> ~/.bash_profile
